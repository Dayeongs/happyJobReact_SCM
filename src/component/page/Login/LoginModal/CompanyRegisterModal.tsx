...
export interface ICompanyRegisterModalProps {
    cust_id: string;
    cust_name: string;
    closeModal: boolean;
    onSuccess: ( ) => void;
...
export const CompanyRegisterModal:FC<ICompanyRegisterModalProps> = ({ cust_id, cust_name, onSuccess }) => {
